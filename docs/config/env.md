...
- **KITE_IMAGE_UPLOAD_MAX_BYTES**: Maximum container image archive size accepted by the admin upload API and offline application bundle import API. Defaults to `4GiB`.
